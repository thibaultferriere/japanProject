    ...
    var i = {
        ...
        s = {
            forEach: function (t, i, s) {
                ...
                else for (var a = 0, e = t.length; e > a; a++)i.apply(s, [t[a], a, t])
            },
            map: function (t, i, s) {
        ...
        a = function () {
            ...
            return t.prototype.draw = function (t) {
                t.save(),
                    ...
                    t.beginPath(),
                    "circle" === this.style ? t.arc(0, 0, this.size, 0, 2 * Math.PI, !1) : "arrow" === this.style && (
                        t.moveTo(-this.size, -this.size),
        ...
        e = function () {
            var t = function (t) {
                ...
                this.startX = i,
                    ...
                    this.strokeStyle = t.color || "#000",
                    this.label = t.label,
                    this.font = t.font,
                    this.shadowBlur = t.shadowBlur
            }
            return t.prototype.draw = function (t) {
                if (t.save(), t.lineWidth = this.lineWidth, t.strokeStyle = this.strokeStyle, t.shadowColor = this.strokeStyle, t.shadowBlur = this.shadowBlur || 2,
                    t.beginPath(), t.arc(this.centerX, this.centerY, this.radius, this.startAngle, this.endAngle, !1), t.stroke(), t.restore(), t.save(), t.fillStyle = this.strokeStyle, this.label) {
                    if (t.font = this.label, this.startLabel) {
                        var i = this.startX - 15, s = this.startY + 5
                        t.fillText(this.startLabel, i, s)
                    }
                    if (this.endLabel) {
                        var i = this.endX - 15, s = this.endY - 5
        ...
        r = function () {
            function t(t) {
                this.x = t.x,
                    ...
                    this.color = t.color,
                    this.shadowBlur = 5,
                    this.lineWidth = t.borderWidth,
                    this.r = 0,
                    this.factor = 2 / t.radius
            }
            return t.prototype.draw = function (t) {
                var s = .5
                this.r += s, t.save(), t.translate(this.x, this.y)
                var a = this.color
                a = i.calculateColor(a, 1 - this.r / this.maxRadius),
                    t.strokeStyle = a,
                    t.shadowBlur = this.shadowBlur,
                    t.shadowColor = a,
                    t.lineWidth = this.lineWidth,
                    t.beginPath(),
                    t.arc(0, 0, this.r, 0, 2 * Math.PI, !1),
                    t.stroke(),
                    t.restore(),
                    Math.abs(this.maxRadius - this.r) < .8 && (this.r = 0)
            }, t
        }(),
        o = function () {
            var t = function (t) {
                ...
                0 > u * f && (0 > u ? (u += 2 * Math.PI, f += 2 * Math.PI) : f += 2 * Math.PI),
                    ...
                    this.endAngle = f,
                    this.radius = p,
                    this.lineWidth = t.width || 1,
                    this.strokeStyle = t.color || "#fff",
                    ...
                    this.animateBlur = !0,
                    this.marker = new a({ x: 50, y: 80, rotation: 50 * Math.PI / 180, style: "arrow", color: "rgb(255, 255, 255)", size: 3, borderWidth: 0, borderColor: this.strokeStyle })
            }
            return t.prototype.drawArc = function (t, i, s, a, e) {
                t.save(),
                    t.lineWidth = s,
                    t.strokeStyle = i,
                    t.shadowColor = this.strokeStyle,
                    t.lineCap = "round",
                    t.beginPath(),
                    t.arc(this.centerX, this.centerY, this.radius, a, e, !1),
                    t.stroke(),
                    t.restore()
            },
                t.prototype.draw = function (t) {
                    var s = this.endAngle,
                        ...
                        e = this.strokeStyle
                    this.animateBlur && (this.arcAngle = a),
                        this.trailAngle = a,
                        e = i.calculateColor(e, .1),
                        this.drawArc(t, e, this.lineWidth, this.startAngle, this.arcAngle)

                    for (var r = this.tailPointsCount, o = 0; r > o; o++) {
                        var n = i.calculateColor(this.strokeStyle, .3 - .3 / r * o), h = 5
                    ...
                    t.save(),
                        t.translate(this.centerX, this.centerY),
                        ...
                        this.marker.draw(t),
                        t.restore(),
                        180 * (s - this.trailAngle) / Math.PI < .5 && (this.trailAngle = this.startAngle, this.animateBlur = !1)
                }, t
        }(),
        n = function () {
            var i = function (t) {
                this.data = t.data,
                    this.store = { arcs: [], markers: [], pulses: [], sparks: [] },
            ...
            return i.prototype.init = function () { this.updateData(this.data) },
                ...
                i.prototype.updateData = function (t) {
                    t && 0 !== t.length && (
                        this.clear(),
                        this.data = t,
                        this.data && this.data.length > 0 && s.forEach(this.data, function (t) {
                            var i = new e({
                                startX: t.from[0],
                                startY: t.from[1],
                                endX: t.to[0],
                            ...
                            this.store.arcs.push(i),
                                this.store.markers.push(s),
                                this.store.pulses.push(n),
                                this.store.sparks.push(h)
                        }, this)
                    )
                },
                i.prototype.start = function (i) {
                    ...
                    this.started || (!function a() {
                        if (s.requestAnimationId = t.requestAnimationFrame(a, i), s.playAnimation) {
                            i.width += 1, i.width -= 1
                            for (var e in s.store) for (var r = s.store[e], o = 0, n = r.length; n > o; o++)r[o].draw(s.context)
                        }
                    }(), this.started = !0)
                },
    ...
    L.MigrationLayer = L.Class.extend({
        ...
        initialize: function (t) {
            this._setOptions(this, t),
                ...
                this._style = {
                    pulse: { radius: this.options.pulseRadius, borderWidth: this.options.pulseBorderWidth },
                    arc: { width: this.options.arcWidth, label: this.options.arcLabel, font: this.options.arcLabelFont }
                } || {},
                this._show = !0, 
                this._init()
        },
        _init: function () {
            ...
            if (t.style.position = "absolute", t.style.width = this._map.getSize().x + "px", t.style.height = this._map.getSize().y + "px",
                this.container = t, this.canvas = document.createElement("canvas"), this.context = this.canvas.getContext("2d"),
                t.appendChild(this.canvas), this._map.getPanes().overlayPane.appendChild(t), !this.migration) {
        ...
        _resize: function () {
            ...
            this.canvas.setAttribute("width", parseInt(e.width, 10)),
                this.canvas.setAttribute("height", parseInt(e.height, 10))
        },
        ...
        _bindMapEvents: function () {
            var t = this
            this._map.on("moveend", function () { t.migration.play(), t._draw() }),
                this._map.on("zoomstart ", function () { t.container.style.display = "none" }),
                this._map.on("zoomend", function () { t._show && (t.container.style.display = "", t._draw()) })
        },
        _draw: function () {
            var t = this._map.getBounds()
